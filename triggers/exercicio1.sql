...
BEGIN
	...
	BEGIN
	   ROLLBACK TRANSACTION
		RAISERROR('O estoque está a baixo da quantidade pedida', 16, 1)
	END
	ELSE
	BEGIN
	   ...
	   BEGIN
	      ...
	      BEGIN
	        PRINT('Apos a venda o estoque estará abaixo do nível adequado.')
	      END
	      ELSE
	      BEGIN
	        PRINT('O estoque esta abaixo do nível adequado.')
	      END
	   END
